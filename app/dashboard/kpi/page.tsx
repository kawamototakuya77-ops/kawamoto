      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            <h3 className="text-sm font-bold text-slate-400 mb-2">昨日のX(Twitter)流入数</h3>
            <p className="text-3xl font-black text-white">GA4連携待ち</p>
            <p className="text-xs text-slate-500 mt-2">※GA4 Explorationにて要確認</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            <h3 className="text-sm font-bold text-slate-400 mb-2">無料トライアル登録数 (CV)</h3>
            <p className="text-3xl font-black text-white">Stripe連携待ち</p>
            <p className="text-xs text-slate-500 mt-2">※Stripe Dashboardにて要確認</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            <h3 className="text-sm font-bold text-slate-400 mb-2">推定CVR</h3>
            <p className="text-3xl font-black text-emerald-400">-- %</p>
            <p className="text-xs text-emerald-500/50 mt-2">目標: 3.0% 以上</p>
          </div>
        </div>
